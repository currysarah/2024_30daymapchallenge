...
ggplot() + 
  geom_sf(data = map_states, fill = "gray", color = "white", size = 4) +
  geom_segment(data = d05_work, aes(x = rlat, y = rlon, xend = wlat, yend = wlon), col = "darkslategray4", size = 0.25, alpha = 0.5, curvature = 0.0) +
  xlim(-2150000, 2074000) +
  ylim(400000.00, 3500000) 
