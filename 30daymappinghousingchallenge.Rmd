...
day03_title <- "<span style='color: #3288BD;'>McKean County's</span> <span style='color: #FFFFFF;'>Median Household Income is **1.4 times** more than the Cost of Living</span> \n <span style='color: #D53E4F;'>Essex County's</span> <span style='color: #FFFFFF;'>Cost of Living is **.58 times** less than the Cost of Living</span>"
...
ggplot() +
  ...
  theme(plot.background = element_rect(fill = "black"),
        plot.title = element_textbox_simple(size = 14, lineheight = 1, halign = 0.5, padding = margin(10, 50, 10, 50)),
        plot.subtitle = element_textbox_simple(size = 9, lineheight = 1, halign = 0.5, padding = margin (5, 15, 20, 15)),
        plot.caption = element_textbox_simple(size = 6, lineheight = 1, halign = 1, padding = margin (10, 30, 20, 30)),
        legend.position = "none",
        panel.background = element_blank(),
...
d04_data <- get_acs(geography = "county",
                    variables = c(avghhsizeoo = "B25010_002", avghhsizero = "B25010_003"), #median household size owners renters
                    year = 2022,
                    geometry = TRUE,
                    output = "wide"
)
