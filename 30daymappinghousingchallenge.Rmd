...
#  annotate("text", x = -75.15, y = 39.9, label = "Cobbs Creek", color = "#7B452C", size = 3, fontface = "bold") +
  ...
  labs(title = "High Risks of Lead",
       ...
       caption = "Data Source: US Census Bureau, ACS 1-year") +
  theme(plot.title = element_textbox_simple(size = 14, lineheight = 1, halign = 0.5, padding = margin(10, 30, 10, 30)),
        plot.subtitle = element_textbox_simple(size = 9, lineheight = 1, halign = 0.5, padding = margin(10, 20, 20, 20)),
...
#, fill = "gray", color = "white", size = 4) +
  geom_segment(data = d05_map, aes(x = rlat, y = rlon, xend = wlat, yend = wlon, color = Workers.in.Commuting.Flow), size = 0.25, alpha = 0.5, curvature = 0.0) +
  ...
  theme(plot.title = element_textbox_simple(size = 14, lineheight = 1, halign = 0.0, padding = margin(10, 10, 10, 30)),
        plot.subtitle = element_textbox_simple(size = 9, lineheight = 1, halign = 0.0, padding = margin(10, 10, 20, 30)),
        plot.caption = element_textbox_simple(size = 6, lineheight = 1, halign = 1),
        legend.position = "none",
        panel.background = element_blank(),
        axis.text.x = element_blank(),
