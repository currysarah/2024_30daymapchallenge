...
#  scale_color_gradient2(limits = c(0, 50000), low = "lightcyan", high = "royalblue4", transform = "log1p") +
  ...
  labs(title = "Commute Patterns Between Counties Pre-Covid",
       subtitle = "Heaviest Commute Routes",
       caption = "Data Source: US Census Bureau, ACS 5-year, 2016-2020") +
  theme(plot.title = element_textbox_simple(size = 14, lineheight = 1, halign = 0.0, padding = margin(10, 30, 5, 30)),
...
#  scale_color_gradient2(limits = c(0, 50000), low = "lightcyan", high = "royalblue4", transform = "log1p") +
  coord_cartesian(xlim = c(-2150000, 2074000), ylim = c(400000, 3500000)) +
  labs(title = "Commute Patterns Between Counties Pre-Covid",
       subtitle = "Longest Commute Routes",
       caption = "Data Source: US Census Bureau, ACS 5-year, 2016-2020") +
  theme(plot.title = element_textbox_simple(size = 14, lineheight = 1, halign = 0.0, padding = margin(10, 30, 5, 30)),
        plot.subtitle = element_textbox_simple(size = 9, lineheight = 1, halign = 0.0, padding = margin(5, 30, 10, 30)),
        plot.caption = element_textbox_simple(size = 6, lineheight = 1, halign = 1),
...
plot_grid(d05_mapa, d05_mapb, labels = c("Heaviest Commute Routes", "Longest Commute Routes"), rel_widths = c(6, 6))
